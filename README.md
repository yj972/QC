...
本节展示将五分类标签合并为二分类后的实验结果：
- 类别1：addressing_obstacles、quantum_algorithms、quantum_programming
- 类别2：methods_of_building_qubits、quantum_computing_model

直接用原有5分类MLP模型推理，合并标签后进行二分类评估。
...
|------|-----------|--------|----------|---------|
| 0    | 0.8523    | 0.9315 | 0.8902   | 1431    |
| 1    | 0.9413    | 0.8718 | 0.9052   | 1802    |
| 宏平均 | 0.8968 | 0.9017 | 0.8977 | 3233 |
| 加权平均 | 0.9019 | 0.8982 | 0.8985 | 3233 |

- 混淆矩阵及详细报告见`results_final/`目录。
- 结果显示，二分类场景下模型表现极佳，AUC接近1，F1分数均衡。 